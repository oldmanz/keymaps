...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT_moonlander(
        _______, Z_REDO,  Z_PASTE, KC_UP,   Z_CUT  , Z_UNDO,  _______,           _______, _______, _______, _______, _______, _______, _______,
        _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  _______,           _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, _______, _______,
        _______, KC_CAPS, KC_PGDN, Z_COPY,  KC_PGUP, KC_INS,  _______,           _______, _______, _______, _______, _______, _______, _______,
    ...
    [MOUSE] = LAYOUT_moonlander(
        _______, Z_REDO,  Z_PASTE, KC_MS_U, Z_CUT  , Z_UNDO,  _______,           _______, _______, _______, _______, _______, _______, _______,
        _______, KC_WH_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R, _______,           _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, _______, _______,
        _______, _______, KC_WH_D, Z_COPY,  KC_WH_U, _______, _______,           _______, _______, _______, _______, _______, _______, _______,
    ...
    [MEDIA] = LAYOUT_moonlander(
        ...
        _______, _______, KC_MPRV, KC_VOLU, KC_MNXT, _______, _______,           _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, _______, _______,
        _______, _______, KC_BRID, KC_VOLD, KC_BRIU, _______, _______,           _______, _______, _______, _______, _______, _______, _______,
