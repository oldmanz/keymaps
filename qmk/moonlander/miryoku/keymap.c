...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        ...
        _______, T_BSPC,  _______, _______, _______, _______,                             _______, _______, _______, _______, T_SPACE, _______,
        T_DEL,   _______, _______, _______, _______,          _______,           _______,          _______, _______, _______, _______, T_TAB,
    ...
    [NAV] = LAYOUT_moonlander(
        ...
        _______, _______, KC_PGDN, KC_INS,  KC_PGUP, _______, _______,           _______, T_MEDIA, _______, _______, _______, _______, _______,
        _______, KC_BSPC, _______, _______, _______, _______,                             _______, _______, _______, _______, _______, _______,
    ...
    [NUM] = LAYOUT_moonlander(
        ...
        _______, _______, _______, _______, _______, T_FUN,   _______,           _______, KC_GRV,  KC_1,    KC_2,    KC_3,    KC_BSLS, _______,
        _______, _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______, KC_0,
    ...
    [SYM] = LAYOUT_moonlander(
        ...
        _______, _______, _______, _______, _______,          _______,           _______,          _______, _______, _______, _______, KC_RPRN,
                                            _______, _______, _______,           _______, _______, _______
    ),
...
const uint16_t PROGMEM esc_combo[] = {T_SPACE, T_TAB, COMBO_END};
const uint16_t PROGMEM ent_combo[] = {T_BSPC, T_DEL, COMBO_END};
const uint16_t PROGMEM ent_combo2[] = {KC_BSPC, KC_DEL, COMBO_END};
const uint16_t PROGMEM stop_combo[] = {KC_MPLY, KC_MUTE, COMBO_END};
const uint16_t PROGMEM dot_combo[] = {KC_0, KC_MINS, COMBO_END};
const uint16_t PROGMEM unds_combo[] = {KC_LPRN, KC_RPRN, COMBO_END};

combo_t key_combos[] = {
    [CAPS_COMBO] = COMBO_ACTION(caps_combo),
    [ESC_COMBO] = COMBO_ACTION(esc_combo),
    [ENT_COMBO] = COMBO_ACTION(ent_combo),
    [ENT_COMBO2] = COMBO_ACTION(ent_combo2),
    [STOP_COMBO] = COMBO_ACTION(stop_combo),
    [DOT_COMBO] = COMBO_ACTION(dot_combo),
    [UNDS_COMBO] = COMBO_ACTION(unds_combo),
};
