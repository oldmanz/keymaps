...
#define LAYOUT_LAYER_MEDIA                                                                    \
    XXXXXXX,RGB_RMOD, RGB_TOG, RGB_MOD, XXXXXXX, XXXXXXX,RGB_RMOD, KC_VOLU, RGB_MOD, XXXXXXX, \
    KC_MPRV, KC_VOLD, KC_MUTE, KC_VOLU, KC_MNXT, KC_MPRV, KC_VOLD, KC_VOLD, KC_VOLU, KC_MNXT, \
    XXXXXXX, XXXXXXX, XXXXXXX, EEP_RST, QK_BOOT, QK_BOOT, EEP_RST, KC_MUTE, XXXXXXX, XXXXXXX, \
...
const uint16_t PROGMEM caps_combo2[] = {LSFT_T(KC_F), RSFT_T(KC_J), COMBO_END};
combo_t key_combos[COMBO_COUNT] = {
    COMBO(caps_combo, CAPS_WORD),
    COMBO(caps_combo2, CAPS_WORD),
};
